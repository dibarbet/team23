 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  toPrint += p1.toString("dwright48");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Seung Lee Kim");
		  toPrint += p2.toString("skim803");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("David Barbet");
		  toPrint += p3.toString("dbarbet3");
                  ...
                  Person5 p5 = new Person5("Yaxiong Liu");
                  toPrint += p5.toString("yliu710");
